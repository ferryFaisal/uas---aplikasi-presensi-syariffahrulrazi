...
if (isset($_SESSION['login']) && $_SESSION['role'] == "Admin") { //jika sudah login
    ...
    die("Anda belum login! Anda tidak berhak masuk ke halaman ini.Silahkan login <a href='\WebProgramming/uas---aplikasi-presensi-syariffahrulrazi/index.php'>di sini</a>");
}
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol>
                    <a href="\WebProgramming/uas---aplikasi-presensi-syariffahrulrazi/register.php"><button type="button" class="btn btn-primary">Add
                            User</button></a>
                </ol>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a class="btn btn-primary" href="\WebProgramming/uas---aplikasi-presensi-syariffahrulrazi/index.php">Logout</a>
                    </div>
                </div>
            </div>
        </div>
